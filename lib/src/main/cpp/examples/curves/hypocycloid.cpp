/*	Gamma - Generic processing library
	...
	Example:		Curve / Hypocycloid
	Description:	A hypocycloid is the trace of a fixed point on a small 
					circle that rolls within a larger circle. This is a primitive 
...
//		mem::zero(pixels, N2);
//
//		csin2.freq(-j/(float)NP);		// Harmonic rotating counter to fundamental
